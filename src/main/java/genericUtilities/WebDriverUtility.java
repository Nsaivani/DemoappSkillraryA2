...
public class WebDriverUtility {
	...
	/**
	 * This method waits until element is displayed on the page
	 * @param time
	 * @param element
	 * @return
	 */
	...
	/**
	 * This method waits until elements on the web page  is enabled to recevie click
	 * @param element
	 * @param time
	 * @return
	 */
	...
	/**
	 * This methos is used to select an element from drop down based on visible text
	 * @param text
	 * @param element
	 */
